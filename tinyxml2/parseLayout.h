 ...
 */
	...
	typedef  std::pair<uIDType, std::weak_ptr<const Node>> WeakPair;
	typedef std::unordered_multimap<uIDType, std::weak_ptr<const Node>> WeakMap;
	typedef WeakMap::const_iterator WeakMapIt;
	typedef std::pair<WeakMapIt, WeakMapIt> WeakMapItPr;
	...
	// check if a key is found or notFound
	enum NodeFound { Found, NotFound, Repeat, Error};
 ...
 ******************************************************************************************************/
	...
	struct LineSegment {
        /***********************************************************************************************
	 * LineSegment initializes using an nTGroup with ll, lower left corner.
	 * 		       The line is the top Y or X border of the ntGroup.
	 * @params[in]   ll   the lower left corner of the Node-- will be the
	 * 			pr.first wil be ll.x or ll.y
	 ...
	 **********************************************************************************************/
        ...
        /***********************************************************************************************
	 * LineSegment initializes a GroupPair storing the BranchNode and the LL
	 * 		       corner.  The line Segment is one of the
	 * 		       splitLines.
	 * @params[in]   gpr   The groupPair of the BranchNode
	 * 	         split The iterator of the line you want to create
	 * @brief              This will create a line segment from one of the
	 * 			split lines within a group.
	 *
	 **********************************************************************************************/
